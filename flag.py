...
TEMPLATES = [
    ...
    (ALL , [], 'signed char'),
    (ALL , [], 'unsigned char'),
    (ALL , [], 'std::strong_ordering'),
    (ALL , [], 'std::weak_ordering'),
    (ALL , [], 'std::partial_ordering'),
    (NONE, [], 'std::mutex'),
    (NONE, [], 'std::thread'),
    (ALL , [], 'std::bitset<262144>'),
    (ALL , [], 'std::chrono::duration'),
    (NONE, [], 'FILE'),
    (NONE, [], 'std::ifstream'),
    (NONE, [], 'std::ofstream'),
    (ALL , [cs(NONE, ALL)], '{}*'),
    ...
    (CMP , [cs(TCMP, ALL)], 'std::unordered_set<{}>'),
    (CMP , [cs(TCMP, ALL)], 'std::unordered_multiset<{}>'),
    ...
    (CMP , [cs(TCMP, ALL), cs(NONE, ALL)], 'std::unordered_map<{}, {}>'),
    (CMP , [cs(TCMP, ALL), cs(NONE, ALL)], 'std::unordered_multimap<{}, {}>'),
